( function($) {
    ...
    function closeMobileMenu() {
        ...
        setTimeout( function() {
            ...
            if ( mobileMenuPanelTrigger.hasClass('open') ) {
                return
            }
    ...
    mobileMenuPanelTrigger.on( 'click ', function(e) {
    ...
    enquiryPanelTrigger.add($('a[href="#enquiry-form"]')).on('click', function(e) {
        console.log('test');
        if (e.cancelable) {
            e.preventDefault();
        }
    ...
    closeSearchPanelTrigger.on('click', function(e) {
